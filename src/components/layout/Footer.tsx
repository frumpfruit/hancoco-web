  ...
  const columns = [
    {
      heading: "Company",
      links: [
        { label: tn("ourStory"), href: `/${locale}/about/our-story` },
        { label: tn("manufacturing"), href: `/${locale}/about/manufacturing` },
        { label: tn("sustainability"), href: `/${locale}/about/sustainability` },
        { label: tn("corporate"), href: `/${locale}/about/corporate` },
        { label: tn("insight"), href: `/${locale}/about/insight` },
      ],
    },
    {
      heading: "Products",
      links: [
        { label: "White Copra", href: `/${locale}/store/white-copra` },
