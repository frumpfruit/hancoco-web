            ...
            <div key={i} style={{ marginBottom: "40px" }}>
              ...
              {section.body.split("\n\n").map((paragraph, j) => {
                if (paragraph.startsWith("* ")) {
                  return (
                    <ul key={j} style={{ paddingLeft: "24px", marginBottom: "16px", listStyleType: "disc", color: "var(--charcoal-soft)" }}>
                      {paragraph.split("\n").map((li, k) => (
                        <li key={k} style={{ fontSize: "15px", lineHeight: "1.7", marginBottom: "8px" }}>
                          {li.replace("* ", "")}
                        </li>
                      ))}
                    </ul>
                ...
                return (
                  <p key={j} style={{
                    ...
                    color: "var(--charcoal-soft)", marginBottom: "16px",
                  }}>
                    {paragraph}
                  </p>
                );
